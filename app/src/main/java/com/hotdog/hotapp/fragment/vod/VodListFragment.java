...
import com.hotdog.hotapp.other.videomanage.controller.ListScrollDistanceCalculator;
import com.hotdog.hotapp.other.videomanage.controller.VideoControllerView;
import com.hotdog.hotapp.other.videomanage.controller.ViewAnimator;
import com.hotdog.hotapp.other.videomanage.manager.SingleVideoPlayerManager;
import com.hotdog.hotapp.other.videomanage.manager.VideoPlayerManager;
import com.hotdog.hotapp.other.videomanage.meta.CurrentItemMetaData;
...
public class VodListFragment extends Fragment implements AbsListView.OnScrollListener, View.OnClickListener {
        ...
        mVideoPlayerView.addMediaPlayerListener(new MediaPlayerWrapper.MainThreadMediaPlayerListener() {
            ...
            public void onInfoMainThread(int what) {
                ...
                if (what == MediaPlayer.MEDIA_INFO_VIDEO_RENDERING_START) {
                    ...
                    //mCurrentVideoControllerView.showWithTitle(tag.title);
    ...
    private class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            holder.setText(R.id.tv_video_name, tag.title);
